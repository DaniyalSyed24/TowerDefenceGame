...
//wave 6
for (var i = 0; i < 100; i++) {
    waves[5].addEnemy("EnemyOrc", 50, 1 / 10000, 5);
}
...
for (var i = 0; i < 45; i++) {
    ...
    waves[8].addEnemy("EnemyOrc", 750, 1 / 2500, 5);
...
for (var i = 0; i < 120; i++) {
    ...
    waves[9].addEnemy("EnemyOrc", 70, 1 / 2500, 5);
}
...
for (var i = 0; i < 200; i++) {
    for (var j = 0; j < 11; j++) {
        waves[11].addEnemy("EnemyOrc", 1000, 1 / 10000, 10);
        waves[11].addEnemy("EnemyOrc", 1050, 1 / 10000, 10);
    }
    waves[11].addEnemy("EnemyOrc", 150, 1 / 3750, 10);
}
waves[11].enemySpawnSpeed = 200;

//wave 13
for (var i = 0; i < 210; i++) {
    waves[12].addEnemy("EnemyOrc", 250, 1 / 15000, 10);
    waves[12].addEnemy("EnemyOrc", 1500, 1 / 15000, 10);
}
